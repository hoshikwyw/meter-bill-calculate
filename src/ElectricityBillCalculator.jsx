    ...
    <div className=" mt-10 flex flex-col gap-5">
      ...
      <div className=" flex flex-col md:flex-row lg:flex-row gap-5 justify-center items-center">
        <input
          ...
          type="text"
          className=" border-2 outline-none px-3 py-1 rounded-md bg-[#5f7adb] font-semibold"
          placeholder="Enter your Meter Units"
        />
        <button
          onClick={calcBill}
          className=" border-2 px-3 py-1 rounded bg-[#a2b2ee] font-semibold">
          Calculate Bill
        </button>
        <button
          className=" border-2 px-3 py-1 rounded bg-[#a2b2ee] font-semibold"
      ...
      <table className=" w-[90%] mx-auto border border-gray-700 my-10 shadow-md shadow-gray-500 bg-[#2e3239]">
        <thead className=" border-2 border-gray-700">
          <tr>
            <th className=" py-2 text-lg ">Unit</th>
            <th className="  py-2 text-lg ">Result</th>
            <th className=" py-2 text-lg ">Total (with tax)</th>
          </tr>
        </thead>
        <tbody className=" border-2 border-gray-500 group">
          {records.map((record, index) => (
            <tr key={index} className=" py-5">
              <td className=" text-center py-3">{record.unit}</td>
              ...
              <td className=" flex justify-end items-center mt-2">
                <button
                  className=" flex items-center gap-2 bg-[#26292b] px-3 py-1 rounded hover:text-red-600"
